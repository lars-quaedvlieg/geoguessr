...
lineMap.set("Outside", ["white", "black", "yellow"])
lineMap.set("Inside", new Map([["Single", ["blue", "green"]], ["Double", ["purple", "red"]]]))
filterList.set("Lines", lineMap)

var filterList = new Map([
    ["Lines", new Map([
    ["Outside", ["white", "black", "yellow"]],
    ["Inside", new Map([
    ["Single", ["blue", "green"]],
    ["Double", ["purple", "red"]]])]])]])
...
var countries = [
    {
        "name" : "Albania",
        "filters" : new Map([["_Continent", ["Europe"]]]),
        "imageExposition" : new Map([["flag", "Images/Flags/al.png"]]),
        "textExpostition" : new Map([])
    },
    {
        "name" : "Nigeria",
        "filters" : new Map([["_Continent", ["Africa"]]]),
        "imageExposition" : new Map([["flag", "Images/Flags/ng.png"]]),
        "textExpostition" : new Map([["_Continent", 'Cool African Country']])
    },
    {
        "name" : "Niger",
        "filters" : new Map([["_Continent", ["Africa"]]]),
        "imageExposition" : new Map([["flag", "Images/Flags/ne.png"]]),
        "textExpostition" : new Map([["_Continent", 'Another Cool African Country']])
    }
]

[ { "name" : "Botswana", "filters" : new Map([
    ["_Continent", ["Africa"]],
